...
export const TRT_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Plan for 60 minutes. Your labs are drawn on-site: a full hormone panel, not a standard GP metabolic panel. Your Virginia provider then reviews every result with you in the same visit, explains what they mean in plain language, and if treatment is appropriate, you leave with a protocol that day. No-cost visit. No obligation to proceed.",
  },
  {
  ...
  },
  {
    ...
    a: "No referral is required. You can schedule your first visit directly. If you'd like to share your results with your primary care provider afterward, we are happy to coordinate that.",
  },
  {
    q: "Can I use my FSA or HSA to pay?",
    a: "Yes. Men's Wellness Centers accepts FSA and HSA cards for all services. Bring your card to your 60-minute in-person visit and our team will process it on-site.",
  },
  {
    q: "Can I visit a different Men's Wellness Centers location?",
    a: "Yes. Your records are accessible across all three Virginia centers. You can book at whichever location is most convenient.",
  },
  {
    q: "Will I leave my first visit with treatment?",
    a: "When clinically appropriate, yes. Many men begin their protocol the same day after labs are drawn and reviewed. Your provider determines what is right for your specific case.",
  },
];
